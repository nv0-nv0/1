...
def home_page() -> str:
    ...
    return doc(
        ...
        <main>
            ...
            <div class="container hero-grid">
              <div class="card strong">
                ...
                <div class="actions">
                  ...
                  <a class="button" href="./products/index.html">제품 보러 가기</a>
                  <a class="button ghost" href="./products/{escape(representative['key'])}/index.html#demo">대표 제품 즉시 데모</a>
                </div>
              ...
              <div class="showcase-grid">
                <article class="card accent">
                  ...
                  <h3 style="font-size:1.75rem;margin:16px 0 10px">회사 메뉴는 NV0 소개만 다룹니다</h3>
                  <p>회사 메뉴에서는 NV0가 어떤 기준으로 제품을 만드는지와 기본 소개만 간결하게 보여드립니다. 실제 체험과 구매는 제품 메뉴에서 바로 이어집니다.</p>
                  <div class="inline-list"><span>브랜드 소개</span><span>고객 기준</span><span>제휴 문의</span></div>
                </article>
                <article class="card strong">
                  <span class="tag">제품</span>
                  <h3>제품 메뉴 안에서 체험부터 결제, 결과 확인까지 한 번에 이어집니다</h3>
                  <p class="lead" style="font-size:1rem">각 제품 상세는 설명만 읽는 페이지가 아니라 바로 체험하고, 가격을 비교하고, 결제한 뒤 결과까지 확인할 수 있는 실행형 페이지입니다.</p>
                  <div class="badge-row"><span class="badge">즉시 체험</span><span class="badge">바로 결제</span><span class="badge">결과 확인</span><span class="badge">공개 글 별도 보기</span></div>
                </article>
              </div>
            </div>
          </section>
          ...
          <section class="section"><div class="container"><div class="section-head"><div><h2>바로 비교하고 바로 선택할 수 있는 4개 제품</h2></div><p>제품 메뉴를 누르면 각 제품으로 이동해 소개·데모·주문·결제·결과 확인까지 바로 이어집니다. 자동발행게시판은 별도로 둘러보거나, 제품 상세 상단에서 먼저 확인할 수 있습니다.</p></div><div class="product-grid" id="product-grid"></div></div></section>
        </main>
        '''),
        page_key='home',
...
def company_page() -> str:
    ...
    return doc(f"회사 | {brand['name']}", '엔브이제로 회사 소개', 'company', dedent(f'''
        <main>
          ...
          <section class="section compact"><div class="container"><div class="section-head"><div><h2>회사 메뉴에서 보실 내용</h2></div><p>이 메뉴는 NV0 소개 전용입니다. 제품 비교와 체험, 구매는 제품 메뉴에서 바로 진행하실 수 있습니다.</p></div><div class="story-grid">{company_sections_markup()}</div></div></section>
        </main>
        ...
        <section class="section">
          <div class="container page-hero">
            <div class="card strong">
              ...
              <h1>마음에 드는 제품을 고르면 바로 체험하고 바로 결정할 수 있습니다</h1>
              <p class="lead">각 제품 상세 안에서 소개, 데모, 주문, 외부 결제, 결과 확인까지 자연스럽게 이어집니다. 자동발행게시판은 별도로 보거나 제품 상세 상단에서 먼저 둘러볼 수 있습니다.</p>
            </div>
            <div class="card accent"><span class="tag" style="background:rgba(255,255,255,.08);border-color:rgba(255,255,255,.12);color:#fff">구매 흐름</span><h3 style="font-size:1.72rem;margin:16px 0 10px">체험 → 플랜 선택 → 외부 결제 → 결과 확인</h3><p>복잡한 문의 절차보다, 직접 써보고 바로 결정할 수 있는 흐름을 우선합니다.</p></div>
          </div>
        </section>
...
def board_page() -> str:
    prefix = rel_prefix(1)
    return doc(f"자동발행게시판 | {brand['name']}", '전체 제품 자동발행게시판', 'board', dedent(f'''
        <main><section class="section"><div class="container page-hero"><div class="card strong"><div class="crumbs"><a href="{prefix}index.html">HOME</a><span class="sep">/</span><span>자동발행게시판</span></div><span class="kicker">추천 글</span><h1>제품을 보기 전에 먼저 읽어보면 좋은 글을 한곳에서 볼 수 있습니다</h1><p class="lead">각 제품에 맞춘 연관 주제 글과 바로 이어지는 체험·구매 CTA를 한 화면에서 확인할 수 있습니다.</p><div class="actions"><a class="button secondary" href="{prefix}products/index.html">제품 목록</a><a class="button" href="{prefix}products/veridion/index.html#board">대표 제품 게시판 먼저 보기</a></div></div><div class="card accent"><span class="tag" style="background:rgba(255,255,255,.08);border-color:rgba(255,255,255,.12);color:#fff">자동화</span><h3 style="font-size:1.72rem;margin:16px 0 10px">먼저 읽어보고 마음이 움직이면 바로 체험하거나 구매할 수 있습니다</h3><p>게시판은 제품 흐름과 별도로 둘러볼 수 있고, 마음에 드는 글을 찾으면 그 자리에서 바로 제품 상세와 구매 단계로 넘어갈 수 있습니다.</p></div></div></section><section class="section compact"><div class="container"><div class="board-grid" id="public-board-grid"></div><div id="public-post-detail"></div></div></section></main>
...
def demo_page() -> str:
    ...
    return doc(f"빠른 체험 | {brand['name']}", '제품 빠른 체험', 'demo', dedent(f'''
        <main><section class="section"><div class="container form-shell"><article class="card strong"><div class="crumbs"><a href="{prefix}index.html">HOME</a><span class="sep">/</span><span>데모</span></div><span class="kicker">Quick demo</span><h1>관심 있는 제품을 골라 바로 샘플 결과를 확인해 보세요</h1><p class="lead">몇 가지 정보만 입력하면 내 상황에 맞춘 샘플 결과를 즉시 확인할 수 있습니다. 마음에 들면 같은 흐름으로 제품 상세에서 바로 구매까지 이어가실 수 있습니다.</p><form id="demo-form"><div class="form-grid"><div><label>제품</label><select name="product" data-prefill="product">{options}</select></div><div><label>회사명</label><input name="company" placeholder="회사명"></div><div><label>목표</label><input name="goal" placeholder="예: 첫 화면에서 바로 이해되게"></div><div><label>핵심 키워드</label><input name="keywords" placeholder="예: 신뢰, CTA, 전환"></div></div><div class="actions"><button class="button" type="submit">샘플 결과 바로 보기</button></div></form><div class="result-box" id="demo-result"></div></article><article class="card"><span class="tag">바로가기</span><h3>마음에 드는 제품으로 바로 이어가세요</h3><div class="story-grid" id="module-matrix"></div></article></div></section></main>
...
def contact_page() -> str:
    ...
    return doc(f"문의 | {brand['name']}", '제품 문의', 'contact', dedent(f'''
        <main><section class="section"><div class="container form-shell"><article class="card strong"><div class="crumbs"><a href="{prefix}index.html">HOME</a><span class="sep">/</span><span>문의</span></div><span class="kicker">Contact</span><h1>제품이 내 상황에 맞는지 편하게 물어보세요</h1><p class="lead">가격, 결과물, 결제 방식처럼 제품을 고르기 전에 궁금한 점이 있으면 이 폼으로 남기실 수 있습니다.</p><form id="contact-form"><div class="form-grid"><div><label>관심 제품</label><select name="product" data-prefill="product"><option value="">선택</option>{options}</select></div><div><label>회사명</label><input name="company" placeholder="회사명"></div><div><label>이메일</label><input name="email" type="email" placeholder="email@company.com"></div><div><label>문의 내용</label><input name="issue" placeholder="예: 가격, 결과물, 적용 범위"></div></div><div class="actions"><button class="button" type="submit">문의 보내기</button></div></form><div class="result-box" id="contact-result"></div></article><article class="card"><span class="tag">안내</span><p>회사 소개는 회사 메뉴에서, 실제 체험과 구매는 제품 메뉴에서, 추가 질문은 이 페이지에서 편하게 남기실 수 있습니다.</p></article></div></section></main>
...
def portal_page() -> str:
    ...
    return doc(f"고객 포털 | {brand['name']}", '고객 조회 포털', 'portal', dedent(f'''
        <main><section class="section"><div class="container form-shell"><article class="card strong"><div class="crumbs"><a href="{prefix}index.html">HOME</a><span class="sep">/</span><span>고객 포털</span></div><span class="kicker">결과 확인</span><h1>결제 후 진행 상태와 결과 자료를 바로 확인하세요</h1><p class="lead">이메일과 조회 코드만 입력하면 주문 상태와 결과 자료를 바로 확인할 수 있습니다. 관련 공개 글은 원할 때 따로 둘러보실 수 있습니다.</p><form id="portal-lookup-form"><div class="form-grid"><div><label>이메일</label><input name="email" type="email" placeholder="email@company.com"></div><div><label>조회 코드</label><input name="code" placeholder="예: NV0-2026-VER-001"></div></div><div class="actions"><button class="button" type="submit">지금 확인하기</button></div></form><div class="result-box" id="portal-result"></div></article><article class="card"><span class="tag">확인 결과</span><h3>구매 상태와 결과 자료가 여기에 표시됩니다</h3><div class="mock-progress" id="portal-mock"><div class="mock-step"><strong>확인 전</strong><span>결제 후 받은 이메일과 조회 코드를 입력하면 바로 확인하실 수 있습니다.</span></div></div></article></div></section></main>
...
def admin_page() -> str:
    ...
    return doc(f"관리자 허브 | {brand['name']}", '운영 관리자 허브', 'admin', dedent(f'''
        <main id="admin-console"><section class="section"><div class="container page-hero"><div class="card strong"><div class="crumbs"><a href="{prefix}index.html">HOME</a><span class="sep">/</span><span>관리자 허브</span></div><span class="kicker">Admin hub</span><h1>주문, 데모, 발행, 포털 상태를 한곳에서 관리합니다</h1><p class="lead">운영자는 이 화면에서 샘플 데이터를 만들고, 결제 상태를 조정하고, 자동발행게시판을 재발행할 수 있습니다.</p><div class="auth-inline"><input id="admin-token-input" placeholder="관리자 토큰"><button class="button secondary" type="button" id="admin-token-save">토큰 저장</button><button class="button ghost" type="button" id="admin-token-clear">토큰 지우기</button></div><div class="toolbar"><button class="button" data-admin-action="seed-demo">샘플 데이터 생성</button><button class="button secondary" data-admin-action="reset-all">엔진 데이터 초기화</button></div><div class="result-box" id="admin-action-result"></div></div><div class="card accent"><span class="tag" style="background:rgba(255,255,255,.08);border-color:rgba(255,255,255,.12);color:#fff">운영 목적</span><h3 style="font-size:1.72rem;margin:16px 0 10px">1인 운영 기준으로 확인 비용을 줄이는 허브</h3><p>반복 확인을 줄이기 위해 주문, 결제, 발행을 같은 기록선으로 관리합니다.</p></div></div></section><section class="section compact"><div class="container"><div class="admin-grid" id="admin-summary"></div></div></section><section class="section compact"><div class="container"><div class="admin-stack" id="admin-orders"></div></div></section><section class="section compact"><div class="container"><div class="record-grid" id="admin-requests"></div></div></section><section class="section compact"><div class="container"><div class="record-grid" id="admin-publications"></div></div></section><section class="section compact"><div class="container"><div class="card strong"><div class="mock-progress" id="admin-feed"></div></div></div></section></main>
...
def toss_fail_page() -> str:
    ...
    return doc(f"결제 실패 | {brand['name']}", 'Toss 결제 실패 안내', 'payment-fail', dedent(f'''
        <main><section class="section"><div class="container form-shell"><article class="card strong"><div class="crumbs"><a href="{prefix}index.html">HOME</a><span class="sep">/</span><span>결제 실패</span></div><span class="kicker">Toss fail</span><h1>결제가 완료되지 않았습니다</h1><p class="lead">잠시 후 다시 결제하시거나, 궁금한 점이 있으면 문의를 남겨주세요.</p><div class="result-box" id="payment-fail-result" style="display:block">실패 정보를 확인하고 있습니다.</div><div class="actions"><a class="button" href="{prefix}checkout/index.html">다시 결제하기</a><a class="button ghost" href="{prefix}contact/index.html">문의 남기기</a></div></article></div></section></main>
...
def product_page(product: dict) -> str:
    ...
    return doc(f"{product['name']} | {brand['name']}", product['summary'], product['theme'], dedent(f'''
        <main>
          ...
          <section class="section compact" id="board"><div class="container"><div class="section-head"><div><h2>{escape(product['name'])} 자동발행게시판</h2></div><p>제품을 자세히 보기 전에 먼저 읽어보면 좋은 글을 모아두었습니다. 연관 주제의 블로그형 글과 바로 이어지는 체험·구매 CTA를 별도로 편하게 확인할 수 있습니다.</p></div><div class="board-grid" id="product-board-grid"></div><div id="product-post-detail"></div></div></section>
          ...
          <section class="section compact" id="demo"><div class="container module-layout"><article class="card strong"><span class="tag theme-chip">즉시 데모</span><h3>몇 가지 정보만 입력하면 샘플 결과를 바로 볼 수 있습니다</h3><form id="product-demo-form" class="stack-form"><div class="form-grid"><div><label>회사명</label><input name="company" data-demo-field="company" placeholder="샘플 브랜드"></div><div><label>목표</label><input name="goal" data-demo-field="goal" placeholder="예: CTA 전환 개선"></div><div><label>핵심 키워드</label><input name="keywords" data-demo-field="keywords" placeholder="예: 랜딩, CTA, 신뢰"></div><div><label>플랜 미리보기</label><select name="plan" data-demo-field="plan"><option value="Starter">Starter</option><option value="Growth">Growth</option><option value="Scale">Scale</option></select></div></div><div class="actions"><button class="button" type="submit">지금 체험해 보기</button><a class="button ghost" href="#order">이 조건으로 바로 구매</a></div></form><div class="result-box" id="product-demo-result"></div></article><article class="card"><span class="tag">체험 포인트</span><h3>데모에서 먼저 보시면 좋은 항목</h3><ul class="clean" id="product-demo-scenarios"></ul></article></div></section>
          <section class="section compact" id="order"><div class="container module-layout"><article class="card strong"><span class="tag theme-chip">주문</span><h3>플랜을 고른 뒤 바로 결제할 수 있습니다</h3><form id="product-checkout-form" class="stack-form"><input type="hidden" name="product" value="{escape(product['key'])}"><div class="form-grid"><div><label>플랜</label><select name="plan" data-prefill="plan"><option value="Starter">Starter</option><option value="Growth">Growth</option><option value="Scale">Scale</option></select></div><div><label>과금 기준</label><select name="billing"><option value="one-time">1회 결제</option><option value="monthly">월 과금</option><option value="project">프로젝트형</option></select></div><div><label>결제 방식</label><select name="paymentMethod"><option value="toss">Toss 결제</option><option value="invoice">세금계산서/송장</option></select></div><div><label>회사명</label><input name="company" placeholder="회사명"></div><div><label>담당자명</label><input name="name" placeholder="담당자명"></div><div><label>이메일</label><input name="email" type="email" placeholder="email@company.com"></div><div><label>추가 요청</label><input name="note" placeholder="예: 원하는 톤, 꼭 포함할 내용"></div></div><div class="actions"><button class="button" type="submit">지금 구매하기</button><a class="button secondary" href="#payment">결제 안내 보기</a></div></form><div class="result-box" id="product-checkout-result"></div></article><article class="card"><span class="tag">플랜</span><h3>지금 선택할 수 있는 플랜</h3><div class="plan-grid" id="plan-grid"></div></article></div></section>
          <section class="section compact" id="payment"><div class="container module-layout"><article class="card strong"><span class="tag theme-chip">결제</span><h3>구매 버튼을 누르면 바로 외부 결제창으로 이동합니다</h3><ol class="flow-list"><li>원하는 플랜과 정보를 확인합니다.</li><li>외부 결제창에서 안전하게 결제를 진행합니다.</li><li>결제가 끝나면 자동으로 결과 확인 화면으로 돌아옵니다.</li><li>완료 즉시 결과 자료를 확인하고 다음 진행을 이어갈 수 있습니다.</li></ol></article><article class="card strong"><span class="tag theme-chip">가격 기준</span><h3>시장 비교 기준</h3><p id="product-pricing-basis"></p><div class="notice">처음 시작하기 부담스럽지 않으면서도 바로 써볼 수 있는 범위를 기준으로 플랜을 나눴습니다.</div></article></div></section>
          <section class="section compact" id="delivery"><div class="container module-layout"><article class="card strong"><span class="tag theme-chip">발행</span><h3>결제 후 결과 자료와 다음 진행이 자연스럽게 이어집니다</h3><ol class="flow-list" id="product-workflow"></ol></article><article class="card strong"><span class="tag theme-chip">함께 보면 좋은 제품</span><h3>비슷한 고민에 이어서 보기 좋은 제품</h3><div class="story-grid" id="product-related-modules"></div></article></div></section>
                    <section class="section compact"><div class="container"><div class="section-head"><div><h2>자주 묻는 질문</h2></div><p>제품 구매 전에 자주 나오는 질문을 먼저 정리했습니다.</p></div><div class="faq-grid" id="product-faq"></div></div></section>
        </main>
...
def product_board_page(product: dict) -> str:
    return doc(f"{product['name']} 게시판 | {brand['name']}", f"{product['name']} 자동발행게시판", product['theme'], dedent(f'''
        <main><section class="section"><div class="container page-hero"><div class="card strong"><div class="crumbs"><a href="../../../index.html">HOME</a><span class="sep">/</span><a href="../../../products/index.html">제품</a><span class="sep">/</span><a href="../../{escape(product['key'])}/index.html">{escape(product['name'])}</a><span class="sep">/</span><span>게시판</span></div><span class="tag theme-chip">추천 글 모음</span><h1>{escape(product['name'])} 자동발행게시판</h1><p class="lead">제품을 보기 전에 먼저 읽어보면 좋은 글, 바로 이어지는 체험·구매 CTA, 실제 결과 기반 카드까지 이 페이지에서 한눈에 볼 수 있습니다.</p><div class="actions"><a class="button" href="../../{escape(product['key'])}/index.html#demo">즉시 데모</a><a class="button secondary" href="../../{escape(product['key'])}/index.html#order">지금 구매하기</a><a class="button ghost" href="../../{escape(product['key'])}/index.html">제품 상세</a></div></div><div class="card theme-panel"><span class="tag" style="background:rgba(255,255,255,.08);border-color:rgba(255,255,255,.12);color:#fff">게시판 안내</span><h3 style="font-size:1.7rem;margin:16px 0 10px">제품을 보기 전에 먼저 둘러보기 좋은 글을 보여드립니다</h3><p>{escape(product['summary'])}</p></div></div></section><section class="section compact"><div class="container"><div class="board-grid" id="product-board-grid"></div><div id="product-post-detail"></div></div></section></main>
