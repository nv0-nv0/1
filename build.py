...
def home_page() -> str:
    ...
    return doc(
        ...
        <main>
            ...
            <div class="container hero-grid">
              ...
              <div class="showcase-grid">
                <article class="card accent">
                  ...
                  <p>회사 메뉴에서는 NV0가 어떤 기준으로 제품을 만들고 운영하는지 간결하게 보여드립니다. 실제 비교와 구매는 제품 메뉴에서 바로 이어집니다.</p>
          ...
          <section class="section"><div class="container"><div class="section-head"><div><h2>고객 상황에 맞춰 바로 비교하고 선택할 수 있는 4개 제품</h2></div><p>제품 메뉴를 누르면 각 제품으로 이동해 소개·데모·주문·결제·결과 확인까지 바로 이어집니다. AI 자동발행 블로그 허브는 별도로 둘러보거나, 제품 상세 상단에서 먼저 확인할 수 있습니다.</p></div><div class="product-grid" id="product-grid"></div></div></section>
        </main>
        '''),
        page_key='home',
        ...
        <section class="section">
          <div class="container page-hero">
            <div class="card strong">
              ...
              <h1>지금 막힌 문제를 기준으로 제품을 고르고 바로 체험해 보세요</h1>
              <p class="lead">각 제품 상세 안에서 소개, 데모, 주문, 외부 결제, 결과 확인까지 자연스럽게 이어집니다. AI 자동발행 블로그 허브는 별도로 보거나 제품 상세 상단에서 먼저 둘러볼 수 있습니다.</p>
            </div>
...
def board_page() -> str:
    ...
    return doc(f"AI 자동발행 블로그 허브 | {brand['name']}", '전체 제품 AI 자동발행 블로그 허브', 'board', dedent(f'''
        <main><section class="section"><div class="container page-hero"><div class="card strong"><div class="crumbs"><a href="{prefix}index.html">HOME</a><span class="sep">/</span><span>AI 자동발행 블로그 허브</span></div><span class="kicker">AI 자동발행 글</span><h1>제품을 보기 전에 먼저 읽어보면 좋은 AI 블로그 글을 한곳에서 볼 수 있습니다</h1><p class="lead">각 제품에 맞춘 AI 자동발행 블로그 글을 먼저 읽고, 마음이 생기면 바로 체험·구매 CTA로 이어질 수 있습니다.</p><div class="actions"><a class="button secondary" href="{prefix}products/index.html">제품 목록</a><a class="button" href="{prefix}products/veridion/index.html#board">대표 제품 AI 글 먼저 보기</a></div></div><div class="card accent"><span class="tag" style="background:rgba(255,255,255,.08);border-color:rgba(255,255,255,.12);color:#fff">자동화</span><h3 style="font-size:1.72rem;margin:16px 0 10px">먼저 읽고 공감한 뒤 바로 체험하거나 구매할 수 있습니다</h3><p>게시판은 짧은 카드 목록이 아니라 AI가 초안을 잡아 준 블로그형 글 허브로 작동합니다. 글을 읽은 뒤 제품 상세와 구매 단계로 바로 넘어갈 수 있습니다.</p></div></div></section><section class="section compact"><div class="container"><div class="board-grid" id="public-board-grid"></div><div id="public-post-detail"></div></div></section></main>
...
def checkout_page() -> str:
    ...
    return doc(f"주문 | {brand['name']}", '제품 주문 및 결제 진입', 'checkout', dedent(f'''
        <main><section class="section"><div class="container form-shell"><article class="card strong"><div class="crumbs"><a href="{prefix}index.html">HOME</a><span class="sep">/</span><span>주문</span></div><span class="kicker">Checkout</span><h1>선택한 제품을 바로 시작하고 결제 후 결과까지 확인할 수 있습니다</h1><p class="lead">플랜을 고르고 결제 버튼을 누르면 외부 결제창으로 이동합니다. 결제 완료 뒤에는 결과 자료를 바로 확인할 수 있고, 공개 글은 원할 때 별도로 둘러보실 수 있습니다.</p><form id="checkout-form"><div class="form-grid"><div><label>제품</label><select name="product" data-prefill="product" required>{options}</select></div><div><label>플랜</label><select name="plan" data-prefill="plan" required><option value="Starter">Starter</option><option value="Growth">Growth</option><option value="Scale">Scale</option></select></div><div><label>과금 기준</label><select name="billing"><option value="one-time">1회 결제</option><option value="monthly">월 과금</option><option value="project">프로젝트형</option></select></div><div><label>결제 방식</label><select name="paymentMethod" required><option value="toss">Toss 결제</option><option value="invoice">세금계산서/송장</option></select></div><div><label>회사명</label><input name="company" placeholder="회사명" autocomplete="organization" required></div><div><label>담당자명</label><input name="name" placeholder="담당자명" autocomplete="name" required></div><div><label>이메일</label><input name="email" type="email" placeholder="email@company.com" autocomplete="email" inputmode="email" required></div><div><label>추가 요청</label><input name="note" placeholder="예: 원하는 톤, 꼭 포함할 내용" autocomplete="off"></div></div><div class="actions"><button class="button" type="submit">지금 시작하기</button></div></form><div class="result-box" id="checkout-result" role="status" aria-live="polite"></div></article><article class="card accent"><span class="tag" style="background:rgba(255,255,255,.08);border-color:rgba(255,255,255,.12);color:#fff">결제 안내</span><h3 style="font-size:1.72rem;margin:16px 0 10px">시작하기 버튼을 누르면 바로 외부 결제창으로 이어집니다</h3><ul class="clean inverse-list"><li>플랜 확인</li><li>외부 결제 진행</li><li>결제 완료 확인</li><li>결과물 준비</li><li>결과 자료 확인</li></ul></article></div></section></main>
...
def product_page(product: dict) -> str:
    ...
    return doc(f"{product['name']} | {brand['name']}", product['summary'], product['theme'], dedent(f'''
        <main>
          ...
          <section class="section compact" id="board"><div class="container"><div class="section-head"><div><h2>{escape(product['name'])} AI 자동발행 블로그 허브</h2></div><p>제품을 자세히 보기 전에 먼저 읽어보면 좋은 AI 자동발행 블로그 글을 모아두었습니다. 연관 주제 글을 충분히 읽고, 마음이 정리되면 바로 체험·구매 CTA로 이어질 수 있습니다.</p></div><div class="board-grid" id="product-board-grid"></div><div id="product-post-detail"></div></div></section>
...
def product_board_page(product: dict) -> str:
    return doc(f"{product['name']} 게시판 | {brand['name']}", f"{product['name']} AI 자동발행 블로그 허브", product['theme'], dedent(f'''
        <main><section class="section"><div class="container page-hero"><div class="card strong"><div class="crumbs"><a href="../../../index.html">HOME</a><span class="sep">/</span><a href="../../../products/index.html">제품</a><span class="sep">/</span><a href="../../{escape(product['key'])}/index.html">{escape(product['name'])}</a><span class="sep">/</span><span>게시판</span></div><span class="tag theme-chip">AI 자동발행 글 모음</span><h1>{escape(product['name'])} AI 자동발행 블로그 허브</h1><p class="lead">제품을 보기 전에 먼저 읽어보면 좋은 글, 바로 이어지는 체험·구매 CTA, 실제 결과 기반 카드까지 이 페이지에서 한눈에 볼 수 있습니다.</p><div class="actions"><a class="button" href="../../{escape(product['key'])}/index.html#demo">바로 체험</a><a class="button secondary" href="../../{escape(product['key'])}/index.html#order">지금 시작하기</a><a class="button ghost" href="../../{escape(product['key'])}/index.html">제품 상세</a></div></div><div class="card theme-panel"><span class="tag" style="background:rgba(255,255,255,.08);border-color:rgba(255,255,255,.12);color:#fff">게시판 안내</span><h3 style="font-size:1.7rem;margin:16px 0 10px">제품을 보기 전에 먼저 둘러보기 좋은 글을 보여드립니다</h3><p>{escape(product['summary'])}</p></div></div></section><section class="section compact"><div class="container"><div class="board-grid" id="product-board-grid"></div><div id="product-post-detail"></div></div></section></main>
